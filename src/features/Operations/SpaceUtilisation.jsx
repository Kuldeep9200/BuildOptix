...
export default function SpaceUtilisation() {
  ...
  return (
    <div className="page" id="pg-space">
      ...
      {/* React Tab Navigation Selector (सिर्फ टैब बदलने के लिए जोड़ा गया है) */}
      <div style={{ display: 'flex', gap: '10px', marginBottom: '15px', borderBottom: '1px solid var(--line-2)', paddingBottom: '10px' }}>
        {['Overview', 'Floor Plans', 'Footfall', 'Leasing'].map((tabLabel, index) => (
          <button
            key={index}
            ...
            style={{
              background: 'none',
              border: 'none',
              color: activeTab === index ? 'var(--ok)' : 'var(--ink-3)',
