    ...
    <div>
      ...
      <div
        style={{
          ...
          gap: '8px',
          marginBottom: '16px',
          borderBottom: '1px solid var(--line-1, #333)',
          paddingBottom: '8px',
        }}
      >
        <button
          ...
          style={{
            ...
            borderRadius: '6px',
            border: 'none',
            background: activeTab === 0 ? 'var(--brand, #d97706)' : 'transparent',
            color: activeTab === 0 ? '#fff' : 'var(--ink-1, #e0e0e0)',
            cursor: 'pointer',
            fontWeight: 600,
          }}
        >
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '6px',
            border: 'none',
            background: activeTab === 1 ? 'var(--brand, #d97706)' : 'transparent',
            color: activeTab === 1 ? '#fff' : 'var(--ink-1, #e0e0e0)',
            cursor: 'pointer',
            fontWeight: 600,
          }}
        >
